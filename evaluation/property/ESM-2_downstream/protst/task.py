...
@R.register("tasks.CustomMultipleBinaryClassification")
class CustomMultipleBinaryClassification(tasks.MultipleBinaryClassification, tasks.Task, core.Configurable):
     def __init__(self, model, task=(), criterion="bce", metric=("auprc@micro", "f1_max"), num_mlp_layer=1,
                 normalization=True, reweight=False, graph_construction_model=None, verbose=0, mlp_dropout=0):
        ...
        self.mlp = layers.MLP(self.model.output_dim, hidden_dims + [len(task)], dropout=mlp_dropout)