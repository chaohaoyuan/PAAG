...
def build_solver(cfg, logger):
    ...
    elif cfg.task["class"] == "MultipleBinaryClassification" or cfg.task["class"] == "CustomMultipleBinaryClassification":
...
def train_and_validate(cfg, solver):
    ...
    for i in range(0, cfg.train.num_epoch, step):
        ...
        # logger.warning('--------------------solver batch size: %d'%(solver.batch_size))
